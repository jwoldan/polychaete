...
class Game {
  ...
  constructor(options) {
    ...
    this.currentScoreElement = options.currentScoreElement;
    this.highScoreElement = options.highScoreElement;
    this.board = new Board(options);
    this.currentScore = 0;
    const cookieHighScore = Cookies.get(HIGH_SCORE_COOKIE);
    this.highScore = cookieHighScore ? parseInt(cookieHighScore) : 0;
  ...
  incrementScore(addlScore) {
    ...
    if (this.currentScoreElement) {
      this.currentScoreElement.innerText = this.currentScore;
    }
